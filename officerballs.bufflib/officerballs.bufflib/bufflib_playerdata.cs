    ...
    public IEnumerable<Token> Modify(string path, IEnumerable<Token> tokens) {
        ...
        foreach (var token in tokens) {
            if (buff_valuelift.Check(token)) {
                ...
                yield return new IdentifierToken("worth");
                yield return new Token(TokenType.OpAssignMul);
                yield return new ConstantToken(new RealVariant(1.4));
                yield return new Token(TokenType.Newline, 3);
                yield return new ConstantToken(new IntVariant(3));
                yield return new Token(TokenType.Colon);
                yield return new IdentifierToken("worth");
                yield return new Token(TokenType.OpAssignMul);
                yield return new ConstantToken(new RealVariant(1.6));
                yield return new Token(TokenType.Newline, 3);
                yield return new ConstantToken(new IntVariant(4));
                yield return new Token(TokenType.Colon);
                yield return new IdentifierToken("worth");
                yield return new Token(TokenType.OpAssignMul);
                yield return new ConstantToken(new RealVariant(1.8));
                yield return new Token(TokenType.Newline, 3);
